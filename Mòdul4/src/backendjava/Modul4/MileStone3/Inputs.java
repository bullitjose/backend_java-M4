...
public class Inputs {
	...
	public static int getIntAmbRang(Scanner sc, String prompt, int min, int max)
		...
		while (isValid == false) {
			i = getInt(sc, prompt);
			if (i <= min) {
				throw new EntradaRangException("----Error, valor ha de ser igual o més gran que " + min);
			} else if (i > max) {
	...
	public static int getInt(Scanner sc, String prompt) throws EntradaIntException {
		...
		while (isValid == false) {
			...
			if (sc.hasNextInt()) {
				...
				throw new EntradaIntException("----Error! Entrada no és Int.");
			}
	...
	public static String introduirString(Scanner sc, String prompt)
		...
		while (isValid == false) {
			...
			if (sc.hasNext()) {
				...
				throw new EntradaStringException("----Error!!. Entrada no és un String");
			}
			sc.nextLine();// Descartar aquesta linea introduida
		}
		return i;
	...
	public static int getInt(String prompt) throws EntradaIntException {
		...
		while (true) {
			...
			try {
				...
				throw new EntradaIntException("Error! Entrada no és un Int.");
			}
		}
		return i;
	}
	...
	public static double getDouble(String prompt) throws EntradaDoubleException {
		...
		while (true) {
			...
			try {
				...
				throw new EntradaDoubleException("Error! Entrada no és Double.");
			}
		}
		return d;
